...
class ShapeHandler:
    ...
    def str_to_shape(self, shape_name):    # Definition of the different trajectory's shapes
        ...
        elif shape_name == "POINT": return self.POINT  # This shape has to be used with path planner which is a variation of the pure pursuit
    ...
    def gen_line_segment(self, start_pt, end_pt):
        # Set tx and ty as our current trajectory points
        cx, cy = [], []
